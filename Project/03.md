...
<style>
.mux table th:first-of-type  { width: 9.091%; }
.mux table th:nth-of-type(2) { width: 9.091%; }
.mux table th:nth-of-type(3) { width: 9.091%; }
.mux table th:nth-of-type(4) { width: 9.091%; }
.mux table th:nth-of-type(5) { width: 9.091%; }
.mux table th:nth-of-type(6) { width: 9.091%; }
.mux table th:nth-of-type(7) { width: 9.091%; }
.mux table th:nth-of-type(8) { width: 9.091%; }
.mux table th:nth-of-type(9) { width: 9.091%; }
.mux table th:nth-of-type(10) { width: 9.091%; }
.mux table th:nth-of-type(11) { width: 9.091%; }
</style>
